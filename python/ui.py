    ...
    def paintEvent(self, _):
        ...
        if self._face_px:
            ...
            p.drawText(QRectF(cx - 80, cy - 14, 160, 28),
                       Qt.AlignmentFlag.AlignCenter, "BUDDY")
...
class LogWidget(QTextEdit):
    ...
    def _next(self):
        ...
        elif tl.startswith("buddy:"):  self._tag = "ai"
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for Buddy", str(Path.home()),
            "All Files (*.*);;"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure Buddy before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("Buddy — MARK XXXIX")
    ...
    def _build_header(self) -> QWidget:
        ...
        mid.addWidget(title)
        sub = QLabel("Beautifully Unified Digital Dynamic Companion")
    ...
    def _on_file_selected(self, path: str):
        ...
        self._file_hint.setText(f"{icon}  {p.name}  ·  {size}  ·  Tell Buddy what to do with it")
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. Buddy online.")
