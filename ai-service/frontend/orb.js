/* ================================================================
   ...
   visual centerpiece / background element of the Hey buddy AI assistant
...
class OrbRenderer {
   ...
   static FRAG = `
    ...
    vec4 draw(vec2 uv){
        ...
        // "light" composite — no longer blends toward the background color directly
        // so that the background remains black and thus transparent.
        vec3 lightCol=(colBase+v1)*mix(1.0,v2*v3,fadeAmt);lightCol=mix(vec3(0.0),lightCol,v0);lightCol=clamp(lightCol,0.0,1.0);
