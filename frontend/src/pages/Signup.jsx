        ...
        <div style={{
            ...
            >
                <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                    ...
                    <h1 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'white', marginBottom: '6px', letterSpacing: '-0.025em' }}>Join VISION UI PRO</h1>
                    <p style={{ color: 'rgba(255, 255, 255, 0.45)', fontWeight: '600', fontSize: '0.85rem', letterSpacing: '0.01em' }}>Experience the future of admin interfaces</p>
                </div>

                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ fontSize: '0.7rem', fontWeight: '800', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.1em', marginLeft: '4px' }}>Full Name</label>
                        <div style={{ position: 'relative' }}>
                            <User size={16} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.4)', zIndex: 2 }} />
                            <input
                                type="text"
                                value={name}
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <label style={{ fontSize: '0.7rem', fontWeight: '800', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.1em', marginLeft: '4px' }}>Password</label>
                        <div style={{ position: 'relative' }}>
                ...
                <div style={{ marginTop: '28px', textAlign: 'center' }}>
                    <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.4)' }}>
                        ...
                        <Link to="/login" style={{ color: '#0075ff', fontWeight: '700', textDecoration: 'none', marginLeft: '4px' }}>
                            Sign In
                        </Link>
                    </p>
                </div>
