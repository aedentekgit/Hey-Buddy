...
class _AnimatedAIInputFieldState extends State<AnimatedAIInputField> with TickerProviderStateMixin {
  ...
  void _onFocusChange() {
    ...
    if (_isFocused) {
      ...
      _rotationController.duration = const Duration(seconds: 8); // slow down when focused
      _rotationController.repeat();
    } else {
      _focusController.reverse();
      _rotationController.duration = const Duration(seconds: 4); // return to normal
      _rotationController.repeat();
    }
  }
    ...
    return MouseRegion(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final hoverVal = CurvedAnimation(parent: _hoverController, curve: Curves.easeOutBack).value;
          final focusVal = CurvedAnimation(parent: _focusController, curve: Curves.easeInOutCubic).value;
          final pulseVal = Curves.easeInOutSine.transform(_pulseController.value);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: widget.isEnabled ? [
                    BoxShadow(
                      color: const Color(0xFF6366F1).withOpacity(0.08 + (0.12 * hoverVal) + (0.05 * pulseVal)),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _isFocused 
                              ...
                              : Colors.white.withOpacity(0.85 + (0.05 * hoverVal)),
                          borderRadius: BorderRadius.circular(100),
                        ),
                        child: Row(
                          children: [
                            ...
                            _buildActionIconButton(
                              ...
                              onTap: widget.isEnabled ? widget.onAttachPressed : null,
                            ),
                            ...
                            AnimatedSwitcher(
                              ...
                              child: _isTyping ? InkWell(
                                key: const ValueKey('send_btn'),
                                onTap: widget.isEnabled ? widget.onSendPressed : null,
                                borderRadius: BorderRadius.circular(100),
                                child: Container(
...
class _GradientRingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (!isEnabled) {
      ...
      final borderRRect = RRect.fromRectAndRadius(borderRect, Radius.circular(size.height / 2));
      final paint = Paint()
