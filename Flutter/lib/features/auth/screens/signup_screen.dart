              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: branding.logoUrl != null
                          ? CachedNetworkImage(
                              ...
                              height: 40,
                              errorWidget: (context, url, error) => Icon(Icons.auto_awesome, size: 30, color: branding.primaryColor),
                            )
                          : Icon(Icons.auto_awesome, size: 30, color: branding.primaryColor),
                    ),
                  ),
                          ...
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                ...
                                style: GoogleFonts.inter(fontWeight: FontWeight.w800, color: branding.primaryColor),
                              ),
                  ...
                  Row(
                    ...
                    children: [
                      Text("Already joined? ", style: GoogleFonts.inter(color: const Color(0xFF64748B), fontWeight: FontWeight.w500)),
                      GestureDetector(
